import { claimParticipantSeat } from "@/domain/rooms/operations";
import {
...
export async function POST(request: Request, { params }: { params: Promise<{ roomId: string }> }) {
  ...
  return actionResponse(await claimParticipantSeat(auth.repository, roomId, await request.json(), context));
}
