import { raiseParticipantObjection } from "@/domain/rooms/operations";
import {
...
export async function POST(request: Request, { params }: { params: Promise<{ roomId: string }> }) {
  ...
  return actionResponse(await raiseParticipantObjection(auth.repository, roomId, await request.json(), context));
}
