...
const fixtureReport: MeetingReport = {
  ...
  keyInputs: [{ id: "position-1", participantId: "participant-engineer", summary: "Capacity is tight this sprint.", category: "capacity", priority: "high", referencedSourceIds: [], createdAt: "2026-08-30T00:00:00.000Z" }],
  constraints: [{ id: "constraint-1", participantId: "participant-engineer", category: "capacity", text: "No authentication rewrite.", priority: "critical", referencedSourceIds: [], createdAt: "2026-08-30T00:00:00.000Z" }],
  proposalsConsidered: [{ id: "proposal-1", participantId: "participant-engineer", title: "Reduced scope onboarding", summary: "Ship the smallest complete onboarding scope.", rationale: "Fits the deadline.", expectedOutcomes: ["Launch on time"], referencedConstraintIds: [], referencedSourceIds: [], parentProposalId: null, status: "accepted", createdAt: "2026-08-30T00:00:00.000Z" }],
